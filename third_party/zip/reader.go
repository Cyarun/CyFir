...
func (z *Reader) init(r io.ReaderAt, size int64) error {
	...
	if _, err = rs.Seek(int64(end.directoryOffset+startOfArchive), io.SeekStart); err != nil {
		return err
	}
...
func readDirectoryEnd(r io.ReaderAt, size int64) (
	dir *directoryEnd, startOfArchive uint64, err error) {
